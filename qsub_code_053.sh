...
# Run the program-
my_pids=( 0 )
/share/apps/anaconda3/bin/python3.7 /home/goliatt/longitudinal_dispersion_coefficient/ldc_evoml_regression_v0p3.py -r 053 > /home/goliatt/longitudinal_dispersion_coefficient/ldc_evoml___053.out 2>&1 &
my_pids[0]=$!
wait ${my_pids[@]}
